...
export const Background: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const currentBgUrl = bgImage === 'default1' 
      ? 'https://raw.githubusercontent.com/zyjsgy/image_store/main/1.png'
      : bgImage === 'default2'
      ? 'https://images.unsplash.com/photo-1454496522488-7a8e488e8606?auto=format&fit=crop&w=1920&q=80'
      : customImages.find(img => img.id === bgImage)?.url || 'https://raw.githubusercontent.com/zyjsgy/image_store/main/1.png';
    ...
    img.onerror = (err) => {
      ...
      fallbackImg.src = "https://raw.githubusercontent.com/zyjsgy/image_store/main/1.png";
      fallbackImg.onload = () => {
